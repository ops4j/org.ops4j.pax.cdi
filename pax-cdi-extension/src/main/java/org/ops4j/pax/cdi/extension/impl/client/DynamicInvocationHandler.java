...
public class DynamicInvocationHandler<S> extends AbstractServiceInvocationHandler<S> {
	...
	public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
		final S service = this.serviceTracker.waitForService(this.timeout);
		if (service == null) {
			throw new ServiceUnavailableException("Service was not available after waiting " + this.timeout + " milliseconds");
		}
