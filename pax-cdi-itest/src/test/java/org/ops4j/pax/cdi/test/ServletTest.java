...
public class ServletTest {
    ...
    public Option[] config() {
        return options(
            ...
            mavenBundle("org.ops4j.pax.web", "pax-web-spi").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-api").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-extender-war").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-extender-whiteboard").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-jetty").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-runtime").version("2.1.0-SNAPSHOT"),
            mavenBundle("org.ops4j.pax.web", "pax-web-jsp").version("2.1.0-SNAPSHOT"),
